...
function MediaPlayerTooltip(props: MediaPlayerTooltipProps) {
  ...
  if ((!tooltip && !shortcut) || context.withoutTooltip) return (
    <>
      {children}
    </>
  );
